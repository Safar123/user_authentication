...
const { signUpUser, logInUser, uploadUserPhoto, resizeUserPhoto } = require('../controller/authController');
const { getAllUser, getSingleUser, updateUserSelf, deleteUser } = require('../controller/userController');

const router = express.Router();
router.route('/signUp').post( uploadUserPhoto, resizeUserPhoto, signUpUser);
